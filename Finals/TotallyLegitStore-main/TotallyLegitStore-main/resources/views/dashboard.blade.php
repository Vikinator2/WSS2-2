...
<head>
    ...
    <title>Totally Legit Store</title>
    ...
    <style>
        ...
        .dashboard-header {
            background: linear-gradient(45deg, var(--store-teal), var(--store-purple));
            color: white;
            padding: 2rem 0;
        ...
        .btn-store {
            background: linear-gradient(45deg, var(--store-teal), var(--store-blue));
            color: white;
            border: none;
            font-weight: 600;
...
<body>
    ...
    <div class="dashboard-header">
        <div class="container">
            ...
            <p class="lead">store EXPO 2025 Merchandise Sales Analytics</p>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row mt-4">
            <div class="col-md-4 mb-3">
                <a href="{{ route('customers.index') }}" class="btn btn-store w-100 py-3">
                    <i class="fas fa-users fa-2x mb-2"></i><br>
                    Manage Customers
                </a>
            </div>
            <div class="col-md-4 mb-3">
                <a href="{{ route('products.index') }}" class="btn btn-store w-100 py-3">
                    <i class="fas fa-store fa-2x mb-2"></i><br>
                    Online Store
                </a>
            </div>
            <div class="col-md-4 mb-3">
                <a href="{{ route('store') }}" class="btn btn-store w-100 py-3">
