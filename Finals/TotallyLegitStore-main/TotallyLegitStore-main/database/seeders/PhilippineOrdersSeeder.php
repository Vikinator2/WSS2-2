        ...
        foreach ($customers as $customer) {
            ...
            for ($j = 0; $j < $orderCount; $j++) {
                ...
                for ($v = 0; $v < $vocaloidItemsCount; $v++) {
                    ...
                    $vocaloidNames = ['Kagamine Rin', 'Kagamine Len', 'Megurine Luka', 'Kaito', 'Meiko', 'Gumi', 'Gakupo', 'Teto Kasane'];
            ...
            // Store purchased items in customer notes (mix of store EXPO and Vocaloid items)
